...
const updateProdfile=async (req, res) => {
  try {
    ...
    let updatedProfile=await profileModel.findByIdAndDelete(req.params.id,{$set:req.body},{new:true});

    return res
      .status(200)
      .json({ status: false, msg: "profile deleted successfully", data: updatedProfile });
